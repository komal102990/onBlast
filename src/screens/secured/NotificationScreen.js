...
import Followers from 'src/components/notification/tabs/Followers';
import Timeline from 'src/components/notification/tabs/Timeline';
...
class NotificationScreen extends Component {
    ...
    componentDidMount() {
        this.props.navigator.setStyle({
            ...
            tabBarHidden: true,
            navBarCustomView: 'NavigationBar',
            navBarNoBorder: true,
